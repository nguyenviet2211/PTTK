...
public class WarehouseStaff extends Staff {
    ...
    public WarehouseStaff(String position, int id, String name, String userName, String password, Date datefBirth, String address, String phoneNumber, String role, String note, String email) {
